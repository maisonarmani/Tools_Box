...
with open('tools_box/__init__.py', 'rb') as f:
...
class CleanCommand(Clean):
	def run(self):
		...
		for relpath in ['build', '.cache', '.coverage', 'dist', 'tools_box.egg-info']:
...
setup(
	name='tools_box',
	version=version,
	description='Tools box contains erpnext extensions for companies',
	author='masonarmani38@gmail.com',
