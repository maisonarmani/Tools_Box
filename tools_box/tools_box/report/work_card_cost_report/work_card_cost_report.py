...
def execute(filters=None):
	...
	data = frappe.db.sql("""select work_card_date,name,vendor,materials_total,labour_fees,transport_fare,work_card_total,work_advance,status
		from `tabJob Card` where (work_card_date between "{}" and "{}") {}
